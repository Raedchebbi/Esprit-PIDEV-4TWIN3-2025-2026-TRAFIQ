...
export default function AdminSidebar() {
    ...
    const navItems = [
        { path: '/admin/dashboard',   Icon: House, label: 'Vue d\'ensemble' },
        { path: '/admin/live',        Icon: Video, label: 'Live Monitoring' },
        { path: '/admin/incidents',   Icon: AlertTriangle, label: 'Incidents', badge: true },
        { path: '/admin/congestion',  Icon: TrafficCone, label: 'Congestion' },
        { path: '/admin/ai-agent',    Icon: Bot, label: 'Agent IA' },
        { path: '/admin/analytics',   Icon: ChartColumn, label: 'Analytics' },
        ...
        <aside className="adm-sidebar">
            ...
            {user?.country && (
                <div className="adm-sb-scope">
                    <Flag className="adm-sb-scope-icon" size={14} aria-hidden="true" />
                    <span className="adm-sb-scope-text">{user.country}</span>
                </div>
            )}
            {isSuperAdmin && (
                <div className="adm-sb-scope adm-sb-scope-global">
                    <Earth className="adm-sb-scope-icon" size={14} aria-hidden="true" />
            ...
            <nav className="adm-sb-nav">
                {navItems.map(item => (
                    ...
                    >
                        <item.Icon className="adm-sb-item-icon" size={18} aria-hidden="true" />
            ...
            <div className="adm-sb-footer">
                ...
                <div className="adm-sb-user-info">
                    ...
                    {user?.country && (
                        <div className="adm-sb-user-country"><LocateFixed size={12} aria-hidden="true" /> {user.country}</div>
                    )}
                </div>
